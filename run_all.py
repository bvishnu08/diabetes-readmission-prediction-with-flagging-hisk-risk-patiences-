...
def main():
    ...
    print("  1. ✅ View results: Check the evaluation output above for metrics")
    print("  2. 🌐 Launch dashboard: See instructions below")
    ...
    if os.name == "nt":
        ...
        print("   # First, activate the virtual environment:")
        print("   .venv\\Scripts\\activate")
        print("   # Then run the dashboard:")
